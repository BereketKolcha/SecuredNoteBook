...
import com.firstapp.securednotebook.data.UserDAO;
import com.firstapp.securednotebook.data.UserDataBase;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences perference=getSharedPreferences("PREFERANCE",MODE_PRIVATE);
        String FirstTime=perference.getString("FirstTimeInstall","");
